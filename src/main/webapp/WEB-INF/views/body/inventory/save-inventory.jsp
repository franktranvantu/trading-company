...
<body>
  ...
  <div class="container w-25">
    <h1 class="text-center mt-4 mb-4">${action} Inventory</h1>
    <form:form action="${contextPath}/inventory/save-inventory" method="post" modelAttribute="inventory" id="save-inventory">
      <form:hidden path="id"/>
